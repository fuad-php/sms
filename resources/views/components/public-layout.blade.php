...
<head>
    ...
    <title>{{ config('app.name', 'School Management System') }} - @yield('title', 'Home')</title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li>
                                <a href="{{ route('announcements.public') }}" class="text-gray-600 hover:text-gray-900 text-sm">
                                    Announcements
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('contact.index') }}" class="text-gray-600 hover:text-gray-900 text-sm">
                                    Contact
                                </a>
                            </li>
                        </ul>
