            ...
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                        ...
                        <ol class="flex items-center space-x-4">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-4 text-sm font-medium text-gray-500">{{ __('app.add_book') }}</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        {{ __('app.add_new_book_to_library') }}
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="call_number" id="call_number" value="{{ old('call_number') }}" 
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <select name="book_type" id="book_type" 
                                            ...
                                            <option value="textbook" {{ old('book_type') == 'textbook' ? 'selected' : '' }}>{{ __('app.textbook') }}</option>
                                            <option value="reference" {{ old('book_type') == 'reference' ? 'selected' : '' }}>{{ __('app.reference') }}</option>
                                            <option value="fiction" {{ old('book_type') == 'fiction' ? 'selected' : '' }}>{{ __('app.fiction') }}</option>
                                            <option value="non_fiction" {{ old('book_type') == 'non_fiction' ? 'selected' : '' }}>{{ __('app.non_fiction') }}</option>
                                            <option value="magazine" {{ old('book_type') == 'magazine' ? 'selected' : '' }}>{{ __('app.magazine') }}</option>
                                            <option value="journal" {{ old('book_type') == 'journal' ? 'selected' : '' }}>{{ __('app.journal') }}</option>
                                        </select>
                                        @error('book_type')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="date" name="acquisition_date" id="acquisition_date" value="{{ old('acquisition_date', date('Y-m-d')) }}" 
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <textarea name="description" id="description" rows="4" 
                                                  ...
                                                  placeholder="{{ __('app.enter_book_description') }}">{{ old('description') }}</textarea>
                                        @error('description')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <textarea name="notes" id="notes" rows="3" 
                                                  ...
                                                  placeholder="{{ __('app.enter_additional_notes') }}">{{ old('notes') }}</textarea>
                                        @error('notes')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <select name="status" id="status" 
                                            ...
                                            <option value="available" {{ old('status', 'available') == 'available' ? 'selected' : '' }}>{{ __('app.available') }}</option>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <select name="condition" id="condition" 
                                            ...
                                            <option value="excellent" {{ old('condition', 'excellent') == 'excellent' ? 'selected' : '' }}>{{ __('app.excellent') }}</option>
                                            <option value="good" {{ old('condition') == 'good' ? 'selected' : '' }}>{{ __('app.good') }}</option>
                                            <option value="fair" {{ old('condition') == 'fair' ? 'selected' : '' }}>{{ __('app.fair') }}</option>
                                            <option value="poor" {{ old('condition') == 'poor' ? 'selected' : '' }}>{{ __('app.poor') }}</option>
                                        </select>
                                        @error('condition')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
