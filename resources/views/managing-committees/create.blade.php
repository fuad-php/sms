...
@section('title', __('app.add_committee_member'))
        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('managing-committees.store') }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <!-- Image -->
                        <div>
                            <label for="image" class="block text-sm font-medium text-gray-700">{{ __('app.image') }}</label>
                            <input type="file" 
                                   name="image" 
                                   id="image" 
                                   accept="image/*"
                        ...
                        <div>
                            ...
                            <textarea name="bio" 
                                      ...
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('bio') border-red-500 @enderror">{{ old('bio') }}</textarea>
                            @error('bio')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
